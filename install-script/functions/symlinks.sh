...
create_symlink_if_needed "${CONFIGS}/skills/log-future-idea" "${HOME}/.codex/skills/log-future-idea"
create_symlink_if_needed "${CONFIGS}/skills/pin-issue" "${HOME}/.codex/skills/pin-issue"
create_symlink_if_needed "${CONFIGS}/skills/log-skills-feedback" "${HOME}/.codex/skills/log-skills-feedback"
create_symlink_if_needed "${CONFIGS}/skills/write-skills" "${HOME}/.codex/skills/write-skills"
create_symlink_if_needed "${CONFIGS}/skills/track-changes" "${HOME}/.codex/skills/track-changes"
create_symlink_if_needed "${CONFIGS}/skills/update-local-skills" "${HOME}/.codex/skills/update-local-skills"
...
create_symlink_if_needed "${CONFIGS}/agents/skills-feedback-log.md" "${HOME}/.codex/skills-feedback-log.md"
...
create_symlink_if_needed "${CONFIGS}/skills/log-future-idea" "${HOME}/.claude/skills/log-future-idea"
create_symlink_if_needed "${CONFIGS}/skills/pin-issue" "${HOME}/.claude/skills/pin-issue"
create_symlink_if_needed "${CONFIGS}/skills/log-skills-feedback" "${HOME}/.claude/skills/log-skills-feedback"
create_symlink_if_needed "${CONFIGS}/skills/write-skills" "${HOME}/.claude/skills/write-skills"
create_symlink_if_needed "${CONFIGS}/skills/track-changes" "${HOME}/.claude/skills/track-changes"
create_symlink_if_needed "${CONFIGS}/skills/update-local-skills" "${HOME}/.claude/skills/update-local-skills"
...
create_symlink_if_needed "${CONFIGS}/agents/skills-feedback-log.md" "${HOME}/.claude/skills-feedback-log.md"
